            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><img src="<?php echo (base_url() . '/assets/img/logo.png'); ?>"
                                width="24px" style="margin-top:-5px;" /> <b>Administrator</b> Login</h3>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col col-sm-6 text-right"><small>Versi 1.10</small></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    success: function (data) {
                        if (data.success == true) {
                            ...
                            /* $('#notifikasi').html('<div class="alert alert-danger">'+
                                     ...
                                     '</div>');*/
                            swal(data.pesan, data.ket, "warning");
                        }
                    },
