                                                        ...
                                                        <div class="panel-body">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <input class="form-control " placeholder=""
                                                                            name="nik" id="nik"
                                                                            value="<?= $data['jamaah_nik']; ?>"
                                                                            maxlength="100" type="text" required>
                                                                        <input name="pelimpahanid" id="pelimpahanid"
                                                                            value="<?= $data['pelimpahan_id']; ?>"
                                                                            type="hidden" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="nama" name="nama"
                                                                    value="<?= $data['jamaah_nama']; ?>" maxlength="100"
                                                                    type="text" required>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" placeholder=""
                                                                            name="tptlahir" id="tptlahir"
                                                                            value="<?= $data['jamaah_tptlahir']; ?>"
                                                                            type="text" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Tanggal
                                                                            Lahir</label>
                                                                        <input class="form-control" placeholder=""
                                                                            name="tgllahir" id="tgllahir"
                                                                            value="<?= $data['jamaah_tgllahir']; ?>"
                                                                            type="date" dateISO="true" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <label class="radio-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            ...
                                                                            <?= ($data['jamaah_jk'] == "L") ? "checked" : ""; ?>>Laki-Laki
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="jk" id="jk"
                                                                            <?= ($data['jamaah_jk'] == "P") ? "checked" : ""; ?> value="P">Perempuan
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="jenis" name="jenis" class="form-control"
                                                                    ...
                                                                    <option value="Meninggal Dunia"
                                                                        <?= ($data['jamaah_jenis'] == "Meninggal Dunia") ? "Selected" : ""; ?>>Meninggal Dunia
                                                                    </option>
                                                                    <option value="Sakit Permanen"
                                                                        <?= ($data['jamaah_jenis'] == "Sakit Permanen") ? "Selected" : ""; ?>>Sakit
                                                                        Permanen
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" placeholder=""
                                                                    name="tglwafat" id="tglwafat"
                                                                    value="<?= $data['jamaah_tgl_wafat']; ?>"
                                                                    type="date" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="panel-body">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group input-group">
                                                                        <input class="form-control" placeholder="1444"
                                                                            name="tahunh"
                                                                            value="<?= $data['haji_tahun_h']; ?>"
                                                                            id="tahunh" type="text" required>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group input-group">
                                                                        <input class="form-control" placeholder="2023"
                                                                            name="tahunm" id="tahunm"
                                                                            value="<?= $data['haji_tahun_m']; ?>"
                                                                            type="text" required>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="keluarga" name="keluarga"
                                                                    ...
                                                                    <option value="Suami"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Suami") ? "Selected" : ""; ?>>Suami</option>
                                                                    <option value="Istri"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Istri") ? "Selected" : ""; ?>>Istri</option>
                                                                    <option value="Ayah"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Ayah") ? "Selected" : ""; ?>>Ayah</option>
                                                                    <option value="Ibu"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Ibu") ? "Selected" : ""; ?>>Ibu</option>
                                                                    <option value="Anak Kandung"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Anak Kandung") ? "Selected" : ""; ?>>Anak Kandung
                                                                    </option>
                                                                    <option value="Saudara Kandung"
                                                                        <?= ($data['jamaah_hub_keluarga'] == "Saudara Kandung") ? "Selected" : ""; ?>>Saudara Kandung
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="provinsi" name="provinsi"
                                                                    ...
                                                                    foreach ($provinsi as $key => $val) {
                                                                        if ($val->kode_propinsi == $data['jamaah_kd_provinsi']) {
                                                                            echo '<option value="' . $val->kode_propinsi . '" selected>' . $val->nama_propinsi . '</option>';
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="alamat"
                                                                    name="alamat"><?= $data['jamaah_alamat']; ?></textarea>
                                                            </div>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="nama">Nama
                                                                    Pelimpahan</label>
                                                                <input class="form-control" id="namap"
                                                                    value="<?= $data['pelimpahan_nama']; ?>"
                                                                    name="namap" maxlength="100" type="text" required>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <input class="form-control " placeholder=""
                                                                    value="<?= $data['pelimpahan_nik']; ?>" name="nikp"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label"
                                                                            for="tptlahir">Tempat Lahir</label>
                                                                        <input class="form-control" placeholder=""
                                                                            value="<?= $data['pelimpahan_tptlahir']; ?>"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Tanggal
                                                                            Lahir</label>
                                                                        <input class="form-control" placeholder=""
                                                                            value="<?= $data['pelimpahan_tgllahir']; ?>"
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <label class="radio-inline">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    value="L"
                                                                                    <?= ($data['pelimpahan_jk'] == "L") ? "checked" : ""; ?>>Laki-Laki
                                                                            </label>
                                                                            <label class="radio-inline">
                                                                                <input class="form-check-input"
                                                                                    type="radio"
                                                                                    <?= ($data['pelimpahan_jk'] == "P") ? "checked" : ""; ?> name="jkp"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <input class="form-control " placeholder=""
                                                                            ...
                                                                            value="<?= $data['pelimpahan_nama_ayah']; ?>"
                                                                            maxlength="100" type="text" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="keluargap" name="keluargap"
                                                                    class="form-control" required>
                                                                    <option value="Suami"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Suami") ? "Selected" : ""; ?>>Suami</option>
                                                                    <option value="Istri"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Istri") ? "Selected" : ""; ?>>Istri</option>
                                                                    <option value="Ayah"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Ayah") ? "Selected" : ""; ?>>Ayah</option>
                                                                    <option value="Ibu"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Ibu") ? "Selected" : ""; ?>>Ibu</option>
                                                                    <option value="Anak Kandung"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Anak Kandung") ? "Selected" : ""; ?>>Anak Kandung
                                                                    </option>
                                                                    <option value="Saudara Kandung"
                                                                        <?= ($data['pelimpahan_hub_keluarga'] == "Saudara Kandung") ? "Selected" : ""; ?>>Saudara Kandung
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="provinsip" name="provinsip"
                                                                    ...
                                                                    <?php
                                                                    foreach ($provinsi as $key => $val) {
                                                                        if ($val->kode_propinsi == $data['pelimpahan_kd_provinsi']) {
                                                                            echo '<option value="' . $val->kode_propinsi . '" selected>' . $val->nama_propinsi . '</option>';
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="alamatp"
                                                                    name="alamatp"><?= $data['pelimpahan_alamat']; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card2 b-0 rounded-0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="kuasa" id="kuasa"
                                                        <?= ($data['menggunakan_kuasa'] == 1) ? "checked" : ""; ?>> Ya
                                                </label>
                                            </div>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="nama">Nama
                                                                    Pemberi Kuasa</label>
                                                                <input class="form-control" id="namak" name="namak" value="<?= $data['kuasa_nama'];?>"
                                                                    maxlength="100" type="text" required>
                                                            ...
                                                            <div class="form-group ">
                                                                <label class="control-label" for="nikk">Nomor Induk
                                                                    Kependudukan (NIK)</label>
                                                                <input class="form-control " placeholder="" value="<?= $data['kuasa_nik']; ?>" name="nikk"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label"
                                                                            for="tptlahir">Tempat Lahir</label>
                                                                        <input class="form-control" placeholder="" value="<?= $data['kuasa_tptlahir']; ?>"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Tanggal
                                                                            Lahir</label>
                                                                        <input class="form-control" placeholder="" value="<?= $data['kuasa_tgllahir']; ?>"
                                                            ...
                                                            <fieldset class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <label class="radio-inline">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="jkk" id="jkk" value="L" <?=($data['kuasa_jk']=="L")?"checked":"";?>
                                                                            checked>Laki-Laki
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input class="form-check-input" type="radio"  <?= ($data['kuasa_jk'] == "P") ? "checked" : ""; ?> 
                                                            ...
                                                            <div class="form-group ">
                                                                <label class="control-label" for="nama_ayah">Nama Ayah
                                                                    Kandung</label>
                                                                <input class="form-control " placeholder="" value="<?= $data['kuasa_nama_ayah'];?>"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="keluargak" name="keluargak"
                                                                    class="form-control" required>
                                                                    <option value="Suami"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Suami") ? "Selected" : ""; ?>>Suami</option>
                                                                    <option value="Istri"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Istri") ? "Selected" : ""; ?>>Istri</option>
                                                                    <option value="Ayah"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Ayah") ? "Selected" : ""; ?>>Ayah</option>
                                                                    <option value="Ibu"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Ibu") ? "Selected" : ""; ?>>Ibu</option>
                                                                    <option value="Anak Kandung"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Anak Kandung") ? "Selected" : ""; ?>>Anak Kandung
                                                                    </option>
                                                                    <option value="Saudara Kandung"
                                                                        <?= ($data['kuasa_hub_keluarga'] == "Saudara Kandung") ? "Selected" : ""; ?>>Saudara Kandung
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="provinsik" name="provinsik"
                                                                    ...
                                                                    <?php
                                                                    foreach ($provinsi as $key => $val) {
                                                                        if($val->kode_propinsi==$data['kuasa_kd_provinsi']){
                                                                        echo '<option value="' . $val->kode_propinsi . '" selected>' . $val->nama_propinsi . '</option>';
...
<script>
    ...
    function tambah() {
        if ($('#data-final').is(":checked")) {
            ...
            var form = $('#basic-form');
            $.ajax({
                url: '<?php echo base_url() . "pelimpahan/prosesedit" ?> ',
                type: 'post',
                data: form.serialize(),
                dataType: 'json',
                beforeSend: function () {
