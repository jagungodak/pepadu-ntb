...
<script>
    ...
    $(document).ready(function () {
        var tabel = $('#dataTables-example').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": '<?php echo base_url('pelimpahan/getAll') ?>',
                "type": "POST",
                "dataType": "json",
                async: "true"
            }
    ...
    function generatePDF(id) {
        Swal.fire({
            title: 'Surat Rekomendasi Pelimpahan Porsi dari Kemanag Kab/Kota',
            text: "Pastikan Semua Berkas Persyaratan sudah Lengkap termasuk Data Jamaah.",
            icon: 'success',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo base_url('pelimpahan/generatePDF') ?>',
                    type: 'post',
                    data: {
                        id: id
                    }
